...
- **pauseOnHover** - Whether the toast pauses when hovered. If the toast or element inside the toast has focus, the timer will not play when mouse leaves the toast. {{ "class": "mb-2", "data-nav": "sublink", "id": "pauseOnHover" }}
